$(function () {
  ...
  const convertPYDateFormatToJS = (formatStr) => {
  ...
  const pythonFormatList = get_format('DATETIME_INPUT_FORMATS')
  let jsFormatList = []
  pythonFormatList.forEach(format => {
    jsFormatList.push(convertPYDateFormatToJS(format))
  })
  ...
  $.fn.datetimepicker.Constructor.Default = $.extend({}, $.fn.datetimepicker.Constructor.Default, {
    ...
    format: jsFormatList[2],
    extraFormats: jsFormatList,
    icons: {
      time: 'far fa-clock',
